<?php  //[STAMP] 7ddcb5d1849a8d2b1c060fbae0df65d1
...
trait IntegrationTesterActions
{
     ...
     * @param $count
     * @see \Helper\Integration::checkUsersCount()
     */
    public function checkUsersCount($count, $cept) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkUsersCount', func_get_args()));
    }
